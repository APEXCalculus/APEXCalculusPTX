...
pdf:
	...
	cd $(PRINTOUT); \
	xsltproc -xinclude --stringparam exercise.divisional.answer no --stringparam exercise.divisional.solution no --stringparam exercise.divisional.hint no $(PTXXSL)/mathbook-latex.xsl $(OUTPUT)/merge.xml > apex.tex; \
	xelatex apex.tex; \
	xelatex apex.tex; \
